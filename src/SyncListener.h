...
#include "cc_fabmap/keyframeMsgStamped.h"
#include "cc_fabmap/keyframeGraphMsgStamped.h"
#include "cc_fabmap/keyframeMsg.h"
#include "cc_fabmap/keyframeGraphMsg.h"
...
public:
	...
	message_filters::Subscriber<cc_fabmap::keyframeMsgStamped> m_kF;
	message_filters::Subscriber<cc_fabmap::keyframeGraphMsgStamped> m_kFG;

	typedef sync_policies::ApproximateTime<	CameraInfo,
			PointCloud2,
			cc_fabmap::keyframeMsgStamped,
			cc_fabmap::keyframeGraphMsgStamped> MySyncPolicy;
...
//	SyncListener(ros::NodeHandle _nh);
	...
	/*! \fn const char SyncListener::callback_SyncListener(const CameraInfoConstPtr& camInfoMsg,const PointCloud2ConstPtr& ptClMsg,const cc_fabmap::keyframeMsgStamped::ConstPtr& kFMsg,const cc_fabmap::keyframeGraphMsgStamped::ConstPtr& kFGMsg,CentralStorage* storage)
	...
	*/
	void callback_SyncListener(const CameraInfoConstPtr& camInfoMsg,
			...
			const cc_fabmap::keyframeMsgStamped::ConstPtr& kFMsg,
			const cc_fabmap::keyframeGraphMsgStamped::ConstPtr& kFGMsg,
			CentralStorage* storage);

	void readkFMsg(const cc_fabmap::keyframeMsgStamped::ConstPtr& kFMsg);

	void readkFGMsg(const cc_fabmap::keyframeGraphMsgStamped::ConstPtr& kFGMsg, CentralStorage * storage);
