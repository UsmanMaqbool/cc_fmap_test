...
SyncListener::SyncListener(int rID,
...
void SyncListener::callback_SyncListener(const CameraInfoConstPtr& camInfoMsg,
...
void SyncListener::readkFMsg(const cc_fabmap::keyframeMsgStamped::ConstPtr& kFMsg) {
...
void SyncListener::readkFGMsg(const cc_fabmap::keyframeGraphMsgStamped::ConstPtr& kFGMsg, CentralStorage * storage) {
